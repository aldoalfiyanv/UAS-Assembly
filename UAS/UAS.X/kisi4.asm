...
hujan_atas
	...
	movlw b'00000111' ;Kolom 1 nyala 
	movwf PORTB
	movlw b'00000111' ;Kolom 1 nyala 
	movwf PORTC
	movlw b'00000111' ;Kolom 1 nyala 
	...
	movlw b'00001110' ;kolom 2 nyala
	movwf PORTB
	movlw b'00001110' ;kolom 2 nyala
	movwf PORTC
	movlw b'00001110' ;kolom 2 nyala
	...
	movlw b'00011100' ;kolom 3 nyala
	movwf PORTB
	movlw b'00011100' ;kolom 3 nyala
	movwf PORTC
	movlw b'00011100' ;kolom 3 nyala
